...
const Onboarding: React.FC<OnboardingProps> = ({ onComplete }) => {
  ...
  const renderWelcome = () => (
    <div className="flex-1 flex flex-col items-center justify-center px-10 text-center animate-in fade-in duration-500 bg-white dark:bg-slate-900">
      ...
      <input 
        ...
        className="w-full bg-slate-50 dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 rounded-2xl px-6 py-4 text-center text-lg font-bold text-slate-800 dark:text-slate-100 outline-none focus:border-blue-300 dark:focus:border-blue-500 transition-all mb-6"
      />
      <button 
        disabled={!name.trim()}
        onClick={nextStep}
  ...
  const renderCommitment = () => (
    <div className="flex-1 flex flex-col items-center justify-center px-10 text-center animate-in slide-in-from-right duration-500 bg-white dark:bg-slate-900">
      <h2 className="text-3xl font-black text-slate-800 dark:text-slate-100 mb-6">Hello, {name} 👋</h2>
      <div className="bg-slate-50 dark:bg-slate-800 rounded-3xl p-8 border border-slate-100 dark:border-slate-700 mb-10">
        ...
        <label className="flex items-center space-x-3 cursor-pointer group">
          <input 
            ...
            className="w-6 h-6 rounded border-slate-300 dark:border-slate-600 text-blue-600 focus:ring-blue-500"
          />
  ...
  const renderTutorialBlocking = () => (
    <div className="flex-1 flex flex-col items-center justify-center px-10 text-center animate-in slide-in-from-right duration-500 bg-white dark:bg-slate-900">
      ...
      <div className="w-full bg-slate-50 dark:bg-slate-800 rounded-2xl p-6 text-left space-y-3 mb-10">
  ...
  const renderTutorialTimer = () => (
    <div className="flex-1 flex flex-col items-center justify-center px-10 text-center animate-in slide-in-from-right duration-500 bg-white dark:bg-slate-900">
      <div className="w-20 h-20 bg-blue-50 dark:bg-blue-900/20 text-blue-500 rounded-3xl flex items-center justify-center mb-8">
  ...
  const renderTutorialSummary = () => (
    <div className="flex-1 flex flex-col items-center justify-center px-10 text-center animate-in zoom-in duration-500 bg-white dark:bg-slate-900">
      <div className="w-24 h-24 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-500 rounded-full flex items-center justify-center mb-10 shadow-lg shadow-emerald-50 dark:shadow-none">
